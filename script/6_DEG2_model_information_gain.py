...
# 2- mnu:
ax_1_p1.plot( years, model_data_from_prior_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
ax_1_p2.plot( years, model_data_from_prior_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
# 4- EFT:
ax_1_p1.plot( years, model_data_from_prior_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )
ax_1_p2.plot( years, model_data_from_prior_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )

# plot cumulative experiment prior information gain:
# 2- mnu:
ax_2_p1.plot( years_cumulative, model_cumulative_info_gain_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
ax_2_p2.plot( years_cumulative, model_cumulative_info_gain_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
# 4- EFT:
ax_2_p1.plot( years_cumulative, model_cumulative_info_gain_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )
ax_2_p2.plot( years_cumulative, model_cumulative_info_gain_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )

# plot differential experiment prior information gain:
# 2- mnu:
ax_3_p1.plot( years_differential, model_differential_info_gain_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
ax_3_p2.plot( years_differential, model_differential_info_gain_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
# 4- EFT:
ax_3_p1.plot( years_differential, model_differential_info_gain_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )
ax_3_p2.plot( years_differential, model_differential_info_gain_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )
...
# legend:
names  = [ '$\\Lambda$CDM', 'Horava', 'EFT alpha', 'EFT 2' ]
...
# export:
plt.savefig(here+'/../results/6_model_information_gain_DEG2.pdf', transparent=True)
plt.clf()
...
for index in xrange(3):
    ...
    if index==1:
        # 2- mnu:
        ax_1_p1.plot( years_cumulative, model_cumulative_info_gain_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
        ax_1_p2.plot( years_cumulative, model_cumulative_info_gain_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
        # 4- EFT:
        ax_1_p1.plot( years_cumulative, model_cumulative_info_gain_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )
        ax_1_p2.plot( years_cumulative, model_cumulative_info_gain_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )

    # plot differential experiment prior information gain:
    if index==2:
        # 2- mnu:
        ax_1_p1.plot( years_differential, model_differential_info_gain_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
        ax_1_p2.plot( years_differential, model_differential_info_gain_alt['Horava'], '-o', markersize=dot_size, color=fc.nice_colors(1) )
        # 4- EFT:
        ax_1_p1.plot( years_differential, model_differential_info_gain_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )
        ax_1_p2.plot( years_differential, model_differential_info_gain_alt['EFT2'], '-o', markersize=dot_size, color=fc.nice_colors(3) )
        # filling:
        if filling:
            ax_1_p1.fill_between( years, model_differential_info_gain_alt['Horava'], 1.e-16, color=fc.nice_colors(1), alpha = alpha )
            ax_1_p2.fill_between( years, model_differential_info_gain_alt['Horava'], 1.e-16, color=fc.nice_colors(1), alpha = alpha )
            ax_1_p1.fill_between( years, model_differential_info_gain_alt['EFT2'], 1.e-16, color=fc.nice_colors(3), alpha = alpha )
            ax_1_p2.fill_between( years, model_differential_info_gain_alt['EFT2'], 1.e-16, color=fc.nice_colors(3), alpha = alpha )
    ...
    # export:
    if index==0:
        plt.savefig(here+'/../results/single/6_model_information_gain_DEG2.pdf', transparent=True)
    elif index==1:
        plt.savefig(here+'/../results/single/6_model_cumulative_information_gain_DEG2.pdf', transparent=True)
    elif index==2:
        plt.savefig(here+'/../results/single/6_model_Differential_information_gain_DEG2.pdf', transparent=True)
